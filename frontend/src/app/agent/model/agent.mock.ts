...
// const agent1: Agent = new Agent(1, 'mock agent 1', [1], 'this is mock data about weather');
...
// const agent2: Agent = new Agent(2, 'mock agent 2', [2, 3], 'this is mock data about movie');


// const agentList: Array<Agent> = [agent1, agent2];
// const behaviorList: Array<Behavior> = [b1, b2, b3, b4, b5, b6, b7, b8];
